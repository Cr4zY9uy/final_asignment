            ...
            <Row>
                ...
                <Col className="detail_product1">
                    ...
                    <div className="d-flex align-items-center">
                        <Button variant="success add_to_cart" onClick={addToCart}   ><i className="bi bi-cart"></i><span style={{ paddingLeft: "10px" }}>Add to cart</span></Button><span><i className="bi bi-heart-fill add-to-favourite" style={{ color: checkFavourite() ? "red" : "#495057" }} onClick={addToFavourite}></i></span>
                    </div>
                        ...
                        return <>
                            <Col xs={4} className="producti" key={index}>
                                <Link to={`/product/${item.product_id}`} >
                                    <img src={item.thumbnail} alt="pic" width={360} height={360} />
