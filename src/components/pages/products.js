...
function Products() {
    ...
    const [[startPrice, endPrice], setPrice] = useState([100, 3000]);
    ...
    useEffect(() => {
        ...
        const hasPriceFilter = startPrice !== 100 && endPrice !== 3000;
        ...
        <div className='products_filter '>
            <div className="filterCAP">
                ...
                <div className='filterPrice'>
                    ...
                    <p className='price_hidden' style={(startPrice === 100 && endPrice === 3000) ? { visibility: "hidden" } : { visibility: "visible" }}>{startPrice}$ - {endPrice}$</p>
